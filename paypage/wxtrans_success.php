    ...
    <div class="weui-msg__text-area">
        ...
        <div class="weui-msg__custom-area">
            <ul class="weui-form-preview__list">
                ...
                <li role="option" class="weui-form-preview__item"><label class="weui-form-preview__label">收款时间</label><p class="weui-form-preview__value weui-cell__ft"><?php echo h($paytime)?></p></li>
            </ul>
        </div>
    </div>
